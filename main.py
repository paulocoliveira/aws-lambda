...
result_policy = create_access_policy_for_lambda()
LAMBDA_ACCESS_POLICY_ARN = result_policy['Policy']['Arn']
print(LAMBDA_ACCESS_POLICY_ARN)

result_role = create_execution_role_for_lambda(LAMBDA_ROLE, LAMBDA_ACCESS_POLICY_ARN)
LAMBDA_ROLE_ARN = result_role['Role']['Arn']
